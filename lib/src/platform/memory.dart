    ...
    case 'macos':
      final data =
          (fluent(exec('vm_stat', []))
              ...
              .mapValue;
      final free =
          (fluent(data['Pages free'])
                ..replaceAll('.', '')
                ..parseInt())
              .intValue;
      final pageSize =
          (fluent(exec('sysctl', ['-n', 'hw.pagesize']))
                ..trim()
                ..parseInt())
              .intValue;
    ...
    case 'macos':
      final pageSize =
          (fluent(exec('sysctl', ['-n', 'hw.pagesize']))
              ...
              .intValue;
      final size =
          (fluent(exec('sysctl', ['-n', 'hw.memsize']))
                ..trim()
                ..parseInt())
              .intValue;
    ...
    case 'macos':
      ...
      final free =
          (fluent(data['Pages free'])
              ...
              .intValue;
      final active =
          (fluent(data['Pages active'])
                ..replaceAll('.', '')
                ..parseInt())
              .intValue;
      final inactive =
          (fluent(data['Pages inactive'])
                ..replaceAll('.', '')
                ..parseInt())
              .intValue;
      final speculative =
